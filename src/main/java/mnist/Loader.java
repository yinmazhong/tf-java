...
public class Loader {
    ...
    static String trainingFile = "~/wkspc/code/TF4Java/src/main/resources/sets/train-images";
    static String trainingLabel = "~/wkspc/code/TF4Java/src/main/resources/sets/train-labels";
    static String testFile = "~/wkspc/code/TF4Java/src/main/resources/sets/test-images";
    static String testLabel = "~/wkspc/code/TF4Java/src/main/resources/sets/test-labels";
